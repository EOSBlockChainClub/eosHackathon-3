...
CONTRACT notechain : public eosio::contract {
  ...
  public:
    ...
    ACTION update( name user, const std::string& firstName, const std::string& lastName, const std::string& userName, int64_t age,
                  std::string &imageHash) {
      ...
      if (isnewuser(user)) {
        ...
        _notes.emplace( _self, [&]( auto& new_user ) {
          ...
          new_user.imageHash   = "50144bd388adcd869bc921349a287690";
        ...
        _notes.modify( note_entry, _self, [&]( auto& modified_user ) {
          modified_user.firstName     = firstName;
          modified_user.age           =    age;
          modified_user.firstName     = firstName;
          modified_user.lastName     =  lastName;
